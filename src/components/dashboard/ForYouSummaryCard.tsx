        ...
        <div className="space-y-3">
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <div className="text-xs font-medium text-purple-200/80 tracking-tight">Flow</div>
              <div className="flex items-center gap-1.5">
                <div className="flex items-center gap-1">
                  <div className="w-1 h-1 rounded-full bg-emerald-400/60" />
                  <span className="text-xs text-emerald-300/80">Up</span>
                </div>
                <div className="flex items-center gap-1">
                  <div className="w-1 h-1 rounded-full bg-rose-400/60" />
                  <span className="text-xs text-rose-300/80">Down</span>
                </div>
              </div>
            </div>
